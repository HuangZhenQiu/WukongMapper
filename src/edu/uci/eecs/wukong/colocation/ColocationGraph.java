...
//						}
						...
						if ((check = isLayeredNodeExist(node, layers.get(layer_index)))!=null){
	...
	private ColocationGraphNode isLayeredNodeExist(ColocationGraphNode node, ArrayList<ColocationGraphNode> layer) {
